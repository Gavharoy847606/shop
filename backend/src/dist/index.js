...
app.get('/api/products', function (req, res) { return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.query('SELECT * FROM products ORDER BY id DESC')];
            case 1:
                result = _a.sent();
...
app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, Promise, function () {
    var _a, sku, name, image_url, quantity, price, result, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.query('INSERT INTO products (sku, name,image_url quantity, price) VALUES ($1, $2, $3, $4,$5) RETURNING *', [sku, name, image_url, quantity, price])];
            case 2:
                result = _b.sent();
