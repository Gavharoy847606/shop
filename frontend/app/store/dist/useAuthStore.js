...
exports.useAuthStore = zustand_1.create()(middleware_1.persist(function (set) { return ({
    ...
    login: function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch(BACKEND_URL + "/api/auth/login", {
                            method: 'POST',
    ...
    logout: function () { return set({ user: null, token: null }); },
    clearError: function () { return set({ error: null }); }
}); }, {
    name: 'stuffus-auth',
    partialize: function (state) { return ({ user: state.user, token: state.token }); }
}));
